...
class BinanceUSDMAdapter(BaseExchangeAdapter):
    ...
    def detect_bracket(orders, window_ms=2000):
        ...
        observe-only WS path), so detection is (symbol, position_side) +
        2s time-window clustering — positionSide is populated and is the
        direction key. Delegates to core.bracket_detection.detect_brackets.
        """
