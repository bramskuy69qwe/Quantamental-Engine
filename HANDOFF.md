...
v2.6 is closed. Next program: **`docs/design/v2.7_model_library_plan.md`**. Retire `/api/backtest/qt-import` (landmine L5 — the Quantower BACKTEST-RESULTS file upload, NOT the plugin) as part of it.
