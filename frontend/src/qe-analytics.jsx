...
import { QEC, mockEquityData, Card, SecLabel, Stat, Lbl, Mono, Btn, Divider, Sparkline, TabBar } from './qe-shared.jsx';
  ...
  <div style={{display:'flex',flexDirection:'column',gap:'6px'}}>
    <Card>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(130px,1fr))',gap:'8px 16px'}}>
        ...
        <div><Lbl>Most Traded Pairs</Lbl><div style={{fontFamily:'JetBrains Mono,monospace',fontSize:'0.78rem',color:QEC.text}}>STOUSDT, JCTUSDT, AIOTUSDT, STRENUSDT, PUFFERUSDT</div></div>
      </div>
    </Card>
...
export const AnalyticsPage = ({tabStyle='line'}) => {
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',gap:'6px',padding:'8px'}}>
      ...
      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:'6px'}}>
        <Mono size="1rem">Portfolio Analytics</Mono>
