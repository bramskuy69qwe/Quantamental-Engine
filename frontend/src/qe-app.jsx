...
import { QEC, Card, SecLabel, Btn } from './qe-shared.jsx';
import { TopNav }       from './qe-nav.jsx';
import { DashboardPage }  from './qe-dashboard.jsx';
import { CalculatorPage } from './qe-calculator.jsx';
import { HistoryPage }    from './qe-history.jsx';
import { AnalyticsPage }  from './qe-analytics.jsx';
import { RegimePage, ParamsPage } from './qe-regime-params.jsx';
...
// ── Tweaks Panel ──────────────────────────────────────────────────────────────
// onTabStyleChange prop added to fix the prototype bug where setTabStyle was
// called from TweaksOverlay without being in scope.
const TweaksOverlay = ({onClose, initialTabStyle='line', onTabStyleChange}) => {
