      ...
      <div style={{display:'flex',flexDirection:'column',gap:'6px'}}>
        ...
        <Card p="8px 10px">
          <div style={{display:'flex',alignItems:'center',gap:'6px',marginBottom:'8px',flexWrap:'wrap'}}>
            ...
            {/* Regime stale warning */}
            {!applyMult && (
              <div style={{display:'flex',alignItems:'center',gap:'4px',padding:'3px 8px',borderRadius:'4px',background:'#251500',border:`1px solid #6b3a00`,fontSize:'0.65rem',color:QEC.amber}}>
                <span>⚠</span> Regime data is stale — multiplier not applied (using 1.0×)
              </div>
            )}
          ...
          <div style={{display:'flex',alignItems:'center',gap:'8px',flexWrap:'wrap'}}>
            ...
            {result ? (
              <>
                ...
                <span style={{fontSize:'0.62rem',color:QEC.muted,fontFamily:'monospace'}}>ATR(100,4h): 933.3025 / ATR(14,4h): 002.2216</span>
              </>
            ) : (
              <span style={{fontSize:'0.72rem',color:QEC.muted}}>—</span>
            )}
          </div>
        </Card>
