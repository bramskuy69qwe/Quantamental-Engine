...
const StepperNumber = ({ value, onChange, step = 1, decimals = 2, min = null, id, placeholder, title, onKeyDown, style }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "stretch", height: 22, background: "var(--qe-panel)", border: "1px solid var(--qe-line)", ...style } }, /* @__PURE__ */ React.createElement(
    "input",
    {
      id,
      className: "qe-input",
      ...
      onBlur: () => {
        const n = parseFloat(value);
        if (!Number.isNaN(n)) onChange(String(clamp(n)));
      },
      onKeyDown: (e) => {
        if (e.key === "ArrowUp") {
          e.preventDefault();
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", borderLeft: "1px solid var(--qe-line)" } }, /* @__PURE__ */ React.createElement("button", { type: "button", tabIndex: -1, title: "increase", onClick: () => bump(1), style: btn }, /* @__PURE__ */ React.createElement("span", { style: tri(true) })), /* @__PURE__ */ React.createElement("button", { type: "button", tabIndex: -1, title: "decrease", onClick: () => bump(-1), style: { ...btn, borderTop: "1px solid var(--qe-line)" } }, /* @__PURE__ */ React.createElement("span", { style: tri(false) }))));
};
...
const ChromeHaltBanner = () => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    {
      tone: hard ? "err" : "warn",
      tag: hard ? "HALT" : "AT CAP",
      title: hard ? "NEW ENTRIES BLOCKED" : "RISK LIMIT REACHED",
      detail: st.halt_reason || (st.dd_state === "limit" ? "drawdown at limit" : "weekly loss at limit") + (hard ? "" : " \xB7 advisory \u2014 entries are NOT blocked")
    }
  );
};
...
const CfgAccountForm = ({ account, detail, onReload, onDelete }) => {
  ...
  ] }), /* @__PURE__ */ React.createElement("div", { className: "qe-mono", style: { fontSize: "0.56rem", color: "var(--qe-muted)", margin: "6px 0 10px", lineHeight: 1.5 } }, "The rolling-DD gate reads the account_settings store \u2014 ABSOLUTE DD thresholds, written by preset Apply (Presets tab; a preset rewrites those and the six sizing knobs, but NOT the four ratios). WEEKLY is different: its effective warn/limit are DERIVED live as Max Weekly Loss \xD7 the two weekly ratios above (account_params) \u2014 the stored weekly columns are dead inputs and are not shown. Weekly has NO enforcement gate by design (advisory-only); the DD advisory\u2192enforced flip ships with its name-confirm safety gate in a later phase."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, marginTop: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement("button", { className: "qe-btn qe-btn-primary", onClick: doSave, disabled: !!busy }, busy === "save" ? /* @__PURE__ */ React.createElement(Spinner, { size: "0.7rem", label: "saving" }) : "Save"), /* @__PURE__ */ React.createElement(
    "button",
    {
      className: "qe-btn",
      onClick: doActivate,
...
const PreTradePage = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "qe-scope", "data-screen-label": "02 Pre-Trade", style: {
    ...
    ))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 4 } }, /* @__PURE__ */ React.createElement(Lbl, null, "TP / SL"), /* @__PURE__ */ React.createElement(PeriodSelector, { options: [["price", "BY PRICE"], ["pct", "BY %"]], value: form.tpslMode, onChange: (v) => setForm((f) => ({ ...f, tpslMode: v })) }), form.tpslMode === "pct" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--qe-muted)", fontSize: "0.56rem" } }, "side"), /* @__PURE__ */ React.createElement(PeriodSelector, { options: [["long", "LONG"], ["short", "SHORT"]], value: form.sideSel, onChange: (v) => setForm((f) => ({ ...f, sideSel: v })) }))), form.tpslMode === "price" ? /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Lbl, null, "TP Price"), /* @__PURE__ */ React.createElement(StepperNumber, { id: "pt-tp", value: form.tpPrice, onChange: set("tpPrice"), step: 0.01, decimals: 4, min: 0, onKeyDown: enterTo(focusId("pt-sl")), style: { color: "var(--qe-green)" } })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Lbl, null, "SL Price"), /* @__PURE__ */ React.createElement(StepperNumber, { id: "pt-sl", value: form.slPrice, onChange: set("slPrice"), step: 0.01, decimals: 4, min: 0, onKeyDown: enterTo(() => doCalculate(false)), style: { color: "var(--qe-red)" } }))) : /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Lbl, null, "TP %"), /* @__PURE__ */ React.createElement(StepperNumber, { id: "pt-tp", value: form.tpPct, onChange: set("tpPct"), step: 0.1, decimals: 1, min: 0, onKeyDown: enterTo(focusId("pt-sl")), style: { color: "var(--qe-green)" } })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Lbl, null, "SL %"), /* @__PURE__ */ React.createElement(StepperNumber, { id: "pt-sl", value: form.slPct, onChange: set("slPct"), step: 0.1, decimals: 1, min: 0, onKeyDown: enterTo(() => doCalculate(false)), style: { color: "var(--qe-red)" } }))), (() => {
...
const LkLinkResolver = ({ item, onDone }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", minHeight: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 7, marginBottom: 6 } }, /* @__PURE__ */ React.createElement("span", { className: "qe-mono", style: { color: "var(--qe-cyan)", fontWeight: 700, fontSize: "0.72rem" } }, item.symbol), /* @__PURE__ */ React.createElement(Badge, { tone: (item.side || "").toUpperCase() === "BUY" || (item.side || "").toUpperCase() === "LONG" ? "ok" : "err" }, (item.side || "").toUpperCase()), /* @__PURE__ */ React.createElement(LinkBadge, { status: item.link_status }), /* @__PURE__ */ React.createElement("div", { className: "qe-grow" }), /* @__PURE__ */ React.createElement("span", { className: "qe-mono", style: { fontSize: "0.52rem", color: "var(--qe-muted)" } }, _lkHM(item.created_at_ms), " \xB7 ", /* @__PURE__ */ React.createElement(PtAge, { ts: item.created_at_ms }))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "5px 10px", padding: "6px 8px", border: "1px solid var(--qe-line)", marginBottom: 8 } }, /* @__PURE__ */ React.createElement(KV, { l: "Order", v: "#" + (item.exchange_order_id || item.id) }), /* @__PURE__ */ React.createElement(KV, { l: "Type", v: (item.order_type || "").toUpperCase() }), /* @__PURE__ */ React.createElement(KV, { l: "Price", v: lpPx(_lkEntryPx(item)), color: "var(--qe-cyan)" }), /* @__PURE__ */ React.createElement(KV, { l: "Size", v: item.quantity != null ? (+item.quantity).toLocaleString(void 0, { maximumFractionDigits: 4 }) : "\u2014" }), /* @__PURE__ */ React.createElement(KV, { l: "Notional", v: _lkEntryPx(item) && item.quantity != null ? `${(_lkEntryPx(item) * item.quantity).toLocaleString(void 0, { maximumFractionDigits: 2 })} U` : "\u2014" }), /* @__PURE__ */ React.createElement(KV, { l: "Operator", v: item.operator_id || "\u2014" }), /* @__PURE__ */ React.createElement(KV, { l: "Client order id", v: item.client_order_id || "\u2014", span: true })), !cands.length ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(EmptyState, { tone: "warn", glyph: "\u2205", msg: "No candidate calcs in window", hint: "Mark unplanned or wait for a fresh calc." }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", paddingTop: 8 } }, /* @__PURE__ */ React.createElement("button", { className: "qe-btn qe-btn-sm qe-btn-ghost", disabled: busy, onClick: () => act("unplanned") }, "UNPLANNED"))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "qe-lbl", style: { margin: "2px 0 5px" } }, "Candidate calcs \xB7 ", cands.length), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 5, flexWrap: "wrap", marginBottom: 6 } }, cands.map((c, ci) => {
    ...
    ModelDialog,
    {
      ...
      footer: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
        ...
        "button",
        {
          ...
          disabled: busy,
          onClick: () => runAct(confirmKind)
        },
        busy ? /* @__PURE__ */ React.createElement(Spinner, { size: "0.62rem" }) : confirmKind === "link" ? "Link calc" : "Mark UNPLANNED"
      ))
    },
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 7 } }, /* @__PURE__ */ React.createElement("span", { className: "qe-mono", style: { color: "var(--qe-cyan)", fontWeight: 700, fontSize: "0.72rem" } }, item.symbol), /* @__PURE__ */ React.createElement(Badge, { tone: (item.side || "").toUpperCase() === "BUY" || (item.side || "").toUpperCase() === "LONG" ? "ok" : "err" }, (item.side || "").toUpperCase()), /* @__PURE__ */ React.createElement("span", { className: "qe-mono", style: { fontSize: "0.56rem", color: "var(--qe-muted)" } }, (item.order_type || "").toUpperCase(), " @ ", lpPx(_lkEntryPx(item)))), confirmKind === "link" && cand ? /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "5px 10px", padding: "6px 8px", border: "1px solid var(--qe-line)" } }, /* @__PURE__ */ React.createElement(KV, { l: "Calc", v: String(cand.calc_id).slice(-8), color: "var(--qe-cyan)" }), /* @__PURE__ */ React.createElement(KV, { l: "Score", v: `${lpScore(cand)} / 6` }), /* @__PURE__ */ React.createElement(KV, { l: "Entry", v: lpPx(cand.effective_entry != null ? cand.effective_entry : cand.average) })) : null, /* @__PURE__ */ React.createElement("div", { className: "qe-mono", style: { fontSize: "0.56rem", color: "var(--qe-muted)", lineHeight: 1.4 } }, confirmKind === "link" ? "Links this order to the selected calc and stamps its fills. The calc moves to MATCHED and leaves Active Calcs." : "Marks this order as an unplanned entry. It leaves the review queue and will not be linked to any calc."))
  ));
};
...
const PrimitivesPage = () => /* @__PURE__ */ React.createElement("div", { className: "qe-scope", "data-screen-label": "00 Primitives", style: {
  ...
  flexDirection: "column",
  overflow: "hidden"
} }, /* @__PURE__ */ React.createElement(TopNavStd, { page: "Primitives", variant: "line", dense: true }), /* @__PURE__ */ React.createElement(PageHeader, { title: "Primitives", subtitle: "standardized component vocabulary \xB7 every page is composed from these" }, /* @__PURE__ */ React.createElement(Badge, { tone: "warn" }, "DEV \xB7 DESIGN-SYSTEM REFERENCE \xB7 DEMO DATA")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minHeight: 0, overflow: "auto", padding: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: 14 } }, /* @__PURE__ */ React.createElement(Card, { pad: true }, /* @__PURE__ */ React.createElement(SecLbl, { rule: true }, "Color tokens \xB7 neon on black"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 8 } }, [
